    ...
    <div class="grid_3 grid_5">
      <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
        <ul id="myTab" class="nav nav-tabs" role="tablist">
          ...
          <li role="presentation"><a href="{{ route('loaimenu',1) }}" >Xem Thêm</a></li>
        </ul>
                      ...
                      <figure>
                        <div class="snipcart-item block" >
                          ...
                          <div class="snipcart-thumb">
                            ...
                            <a><img src="public/resources/uploads/detail/{{ $item->image }}" width="200px" height="200px"/></a>
                            <p>{{ $item->tensp }}</p>
                            <p>
                      ...
                      <div class="modal-body">
                      			<div class="agileinfo_single">
                      				...
                      				<div class="col-md-4 agileinfo_single_left">
                      					<img id="example" src="public/resources/uploads/detail/{{ $item->image }}" alt=" " class="img-responsive">
                      				</div>
