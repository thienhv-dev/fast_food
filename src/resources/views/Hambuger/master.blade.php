...
<script type="text/javascript" src="TrangChu/js/jquery-1.11.1.min.js"></script>
	...
	<div class="agileits_header">
		<div class="container">
			...
			<div class="agile-login">
				<ul>
					<li>
						<a href="{{ route('menu') }}"> Chọn Tỉnh/Thành Phố </a>
					</li>
					<li><a href="{{ route('menu') }}">Trợ Giúp</a></li>
				</ul>
			</div>
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="{{ route('menu') }}">Buger TiTa</a></h1>
			</div>
			...
			<nav class="navbar navbar-default">
                ...
                <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="{{ route('menu') }}" class="act">Giới thiệu</a></li>
                        <!-- Mega Menu -->
                        <li><a href="{{ route('loaimenu',1) }}">Thực Đơn</a></li>
                        <li><a href="{{ route('menu') }}">Nhà hàng</a></li>
                        <li><a href="{{ route('menu') }}">Khuyến mãi</a></li>
                        <li><a href="{{ route('menu') }}">Nghề nghiệp</a></li>
                        <li><a href="{{ route('menu') }}">Thư viện ảnh</a></li>
                        <li><a href="{{ route('menu') }}">Thành viên</a></li>
                        <li>
                        </li>
                    </ul>
                </div>
