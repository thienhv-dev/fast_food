...
class MenuController extends Controller
{
    ...
    public function postAdd(MenuRequest $menu_request){
        ...
        if($menu_request->hasFile('fImages')){
            ...
            foreach ($files as $file) {
                ...
                $file->move('public/resources/uploads/detail/',$file_name);
    ...
    public function getDelete($id){
        ...
        foreach ($menu_detail as $value){
            File::delete('public/resources/uploads/detail/'.$value["image"]);
        }
        $menu = Menu::find($id);
        $menu->delete($id);
        ...
        if(!empty(Request::file('fImages'))){
            foreach (Request::file('fImages') as $file){
                ...
                if (isset($file)){
                    ...
                    $file->move('public/resources/uploads/detail/',$file->getClientOriginalName());
                    $product_img->save();
                }
            }
        }
